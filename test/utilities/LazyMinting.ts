 ...
 */
 class LazyMinting {
  ...
  async createVoucher(nftAddress: any,tokenId: any, price: any,tokenUri: any, royaltyKeeper: any,royaltyFees: any) {
    const voucher = {nftAddress,tokenId,price,tokenUri,royaltyKeeper,royaltyFees};
