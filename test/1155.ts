...
describe("singleMarketplace 1155 ",async()=>{
  ...
  it("custodial to custodial buy", async () => {
    ...
    await singleMarketplace.Buy(Voucherbuy,VoucherSell,voucher,false);
    ...
    await singleMarketplace.Buy(Voucherbuy2, VoucherSell2, voucher2,false);
  ...
  it("ERROR custodial to custodial primary buy:invalid buyer", async () => {
    ...
    await usdt
      .connect(owner)
      .approve(singleMarketplace.address, expandTo6Decimals(1000));
    await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("invalid buyer");
    });
  ...
  it("ERROR custodial to custodial primary buy : buyer and nft mismatched addresses", async () => {
    ...
    await usdt
      .connect(owner)
      .approve(singleMarketplace.address, expandTo6Decimals(1000));
    await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("Addresses invalid");
    });
    ...
    it("ERROR custodial to custodial primary buy : invalid price", async () => {
      ...
      await usdt
        .connect(owner)
        .approve(singleMarketplace.address, expandTo6Decimals(1000));
      await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("Prices invalid");
      });  
      ...
      it("ERROR custodial to custodial secondary buy :invalid Seller", async () => {
        ...
        await usdt
          ...
          .approve(singleMarketplace.address, expandTo6Decimals(1000));
        await TRS.connect(signers[6]).setApprovalForAll(singleMarketplace.address,true);
        await expect(singleMarketplace.Buy(Voucherbuy2, VoucherSell2, voucher2,false)).to.be.revertedWith("invalid Seller");
      });
      ...
      it("custodial to custodial secondary buy errror: invalid buyer", async () => {
        ...
        await usdt
          ...
          .approve(singleMarketplace.address, expandTo6Decimals(1000));
        await TRS.connect(signers[6]).setApprovalForAll(singleMarketplace.address,true);
        await expect(singleMarketplace.Buy(Voucherbuy2, VoucherSell2, voucher2,false)).to.be.revertedWith("invalid buyer");
      });
  ...
  it("ERROR custodial to noncustodial primary buy:  mismatched addresses", async () => {
    ...
    await usdt
      .connect(signers[6])
      .approve(singleMarketplace.address, expandTo6Decimals(1000));
    await expect (singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("");
  });
  ...
  it("ERROR custodial to noncustodial primary buy: invalid price", async () => {
    ...
    await usdt
      .connect(signers[6])
      .approve(singleMarketplace.address, expandTo6Decimals(1000));
    await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("invalid price");
  });
...
it("ERROR non custodial to non custodial buy: invalid buyer", async () => {
  ...
  it("ERROR 1155 Buy: Addresses doesn't match",async()=>{
    ...
    it("1155buy: counters mismatched",async()=>{
      ...
      await usdt.connect(owner).approve(singleMarketplace.address,expandTo6Decimals(1000));
      //console.log("NFT balance of first buyer before buy:",await TRS.balanceOf(signers[6].address,1));
      await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("Counters invalid");
      })
      ...
      it("ERROR 1155 buy: mismatched amounts",async()=>{
        ...
        await usdt.connect(owner).approve(singleMarketplace.address,expandTo6Decimals(1000));
        //console.log("NFT balance of first buyer before buy:",await TRS.balanceOf(signers[6].address,1));
        await expect(singleMarketplace.Buy(Voucherbuy, VoucherSell, voucher,false)).to.be.revertedWith("Amounts invalid");
      })    
      ...
      describe("setter functions",async()=>{
        it("Update Operator",async()=>{
            ...
            //await template1155.connect(signers[1]).updateOperator("0x0000000000000000000000000000000000000000",true);
        }) 
